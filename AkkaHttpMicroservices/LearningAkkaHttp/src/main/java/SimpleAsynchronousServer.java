...
public class SimpleAsynchronousServer {
    ...
    Function<HttpRequest, CompletionStage<HttpResponse>> asynchronizeMethodHandler = (httpRequest) -> {
    ...
    public void run(){
        ...
        Flow<IncomingConnection, IncomingConnection, NotUsed> flow =
                Flow.of(IncomingConnection.class).map( connection -> {
                    ...
                    connection.handleWithAsyncHandler(asynchronizeMethodHandler, Materializer.createMaterializer(actorSystem));
